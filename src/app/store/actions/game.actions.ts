...
export const answerQuestion = createAction('[Game/API] Answer Question', props<{ awnser: IAnswer }>());
export const submitAnswers = createAction('[Game/API] Submit Answers', props<{playerId: string, awnsers: IAnswer[] }>());
