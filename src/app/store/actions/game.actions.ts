...
export const loadQuestionsSuccess = createAction('[Game/API] Load Questions Success', props<{ questions: IQuestions[] }>());
...
export const submitAnswers = createAction('[Game/API] Submit Answers', props<{ answers: IAnswer[] }>());
